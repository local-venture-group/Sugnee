...
class CorporationJobofferFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = CorporationJoboffer::class;

    // protected $cityArray = JobConditionConsts::CITY;

    // public function __construct()
    // {
    //     $cityArray = array_values($this->cityArray);
    // }
