      ...
      <div className="container mx-auto mt-10 px-8 md:px-28">
        <div className="w-full flex">
          ...
          <div className="hidden lg:flex flex-col justify-end w-1/4">
            <button className="btn btn-outline w-3/4 mb-4">
              お気に入りに追加
            </button>
            <button className="btn w-3/4">応募する</button>
          </div>
        </div>

        <p className="bg-gray-100 px-2 py-3 w-full mt-10">仕事内容</p>
        <p className="mt-8">{job.job_description}</p>
        <p className="bg-gray-100 px-2 py-3 w-full mt-10">募集要項</p>
          ...
          <table className="table-fixed w-full mt-8 break-all">
            <tbody>
              <tr className="border-b border-gray-300">
                ...
                <td className="w-3/4 p-8">{job.work_type}</td>
              </tr>
              <tr className="border-b border-gray-300">
